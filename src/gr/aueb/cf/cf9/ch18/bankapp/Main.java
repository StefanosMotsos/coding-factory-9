            ...
            try {
                switch (option) {
                    case "1" -> {
                        ...
                        System.out.println("Ο λογιαρασμός δημιουργήθηκε (ανανεώθηκε) επιτυχώς με iban: " +
                    ...
                    case "3" -> {
                        ...
                        System.out.println("Επιτυχής κατάθεση: " + withdrawAmount + ", Υπόλοιπο: "
                                + accountController.getBalance(iban));
                    }
                    case "4" -> {
                        System.out.println("Παρακαλώ εισάγετε το iban: ");
                    ...
                    default -> System.out.println("Μη έγκυρη επιλογή. Προσπάθησε ξανά.");
                }
            } catch (AccountNotFoundException e) {
                System.out.println("Ο λογαρισμός δεν βρέθηκε.");
            } catch (NumberFormatException e) {
                System.out.println("Μη έγκυρη μορφή αριθμόυ");
            } catch (ValidationException e) {
                System.out.println("Λάθος στην επαλήθευση: " + e.getMessage());
            } catch (InsufficientBalanceException e) {
                System.out.println("Ανεπαρκής υπόλοιπο.");
            }
        }
    }
