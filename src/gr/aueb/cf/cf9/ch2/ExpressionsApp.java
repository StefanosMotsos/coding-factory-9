...
public class ExpressionsApp {
    ...
    public static void main(String[] args) {
        ...
        int result6 = (num1 + num2) * (result1 / result2) + (result3 % result4);
